...
Usage of ./artifacts/proxeus:
  ...
  -AirdropEnabled string
    	Enables/Disables the XES & Ether airdrop feature on testnet. (PROXEUS_AIRDROP_ENABLED) (default "false")
  ...
  -BlockchainNet string
    	Ethereum blockchain net like mainnet or goerli or polygon-mainnet or polygon-mumbai. (PROXEUS_BLOCKCHAIN_NET) (default "goerli")
  -CacheExpiry string
